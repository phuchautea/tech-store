                    ...
                    <div class="page-layout">
                        <div class="wrapper-row pd-page">
                            <div class="container-fluid">
                                <h1 style="color:red; text-align:center">TẠO TÀI KHOẢN</h1>
                                <div class="col-md-6 col-xs-12 wrapbox-content-account">
                                    <div id="customer-login">
                                        <div id="login" class="userbox">
                                            ...
                                            <form accept-charset="UTF-8" action="/account/register" id="customer_login" method="post">
                                                @csrf
                                                @include('alerts')
                                                <div class="clearfix large_form">
                                                    <input autofocus required="" type="text" value="" name="name" id="name"
                                                ...
                                                <div class="clearfix action_account_custommer">
                                                    <div class="action_bottom dark">
                                                        <input style="width:100%" class="btn btn-signin" type="submit" value="Tạo tài khoản">
                                                    </div>
                                                    <div class="req_pass">
                                                        <a href="#" onclick="showRecoverPasswordForm();return false;"><b>Quên mật khẩu?</b></a>
                                                        hoặc <a href="/account/login" title="Đăng nhập"><b>Đăng nhập</b></a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
